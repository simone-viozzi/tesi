...
\usepackage{amsfonts}
\usepackage{hyperref}[backref]%\hyperref[appendix:test]{A}
\hypersetup{
	colorlinks = true,
	allcolors = {blue},
	linktocpage=true
...
\newtcblisting{bashcode}[1][]{
    ...
    minted options={linenos=true,numbersep=3mm,texcl=true,#1,breaklines,texcomments,fontsize=\footnotesize},
    left=5mm,enhanced,
