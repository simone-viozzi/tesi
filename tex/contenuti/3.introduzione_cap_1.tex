...
%%        discussed in Chapter 3.
    ...
    % TODO da rivedere
    \item[1.] \textbf{Link Layer}: E' il layer più vicino al mezzo fisico su cui viaggiano i dati, ogni host deve implementare il protocollo usato per la specifica interfaccia che usa. Ad esempio un'host con un'interfaccia Ethernet deve implementare i protocolli \it{Ethernet II} e \it{IEEE 802.3}.
...
% TODO da sistemare
\begin{itemize}
    \item \textbf{Transport Layer Security}\cite{RFC_8446}: E' il dato effettivo che è stato trasmesso in rete  
