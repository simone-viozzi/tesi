...
OpenVPN e' un applicativo open source che ha l' obbiettivo di fornire una VPN che sia semplice da configurare e che funzioni in ogni contesto. Openvpn puo' incapsulare sia pacchetti IP che frame Ethernet, in un tunnel sicuro che puo' viaggiare sia su TCP che UDP. Ha molte opzioni di configurazione, come la possibilita' di usare qualsiasi porta, oppure l'uso della compressione. Il tutto e' concentrato in un singolo applicativo che puo' funzionare sia da client che da server, in base alla configurazione fornita.
