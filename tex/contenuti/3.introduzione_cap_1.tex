...
\begin{itemize}
    ...
    \item \textbf{Ethernet II}\cite{ethernet-ii}: il questo caso il mezzo fisico è una porta Ethernet quindi il pacchetto IP viene incapsulato con il protocollo Ethernet II. Nell'header Ethernet II sono contenuti l'indirizzo MAC di sorgente e destinazione, ciò permette di individuare a quale host è l'intefaccia fisica di destinazione.
\end{itemize}

Possiamo vedere graficamente il pacchetto descritto in \ref{code:tls-wireshark} e le informazioni principali di ogni header:
