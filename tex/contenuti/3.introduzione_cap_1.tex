...
%%        Name System (DNS) protocols.
    ...
    I protocolli principali di questo livello sono TCP e UDP: il tcp e' connection-oriented e fornisce alta affidabilita'; mentre l'udp e' connection-less, quindi non si hanno garanzie su... cosa?. % TODO!
