...
Per testare la connessione tra \code{client} e \code{host-domotico} usiamo sia \code{ping} che \code{tracepath}, possiamo inoltre usare \code{tcpdump} sul \code{Server} e \code{Router} per vedere il percorso dei pacchetti.
