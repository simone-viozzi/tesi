...
È stato fornito dall'azienda \textit{Esse-ti}, consiste in un gateway 4G con funzionalità di router. Le specifiche complete possono essere trovate sul sito del produttore (\href{https://www.esse-ti.it/4g-router}{link}).
...
Il sistema operativo del \textit{Router} è una versione personalizzata di OpenWRT, le funzionalità sono le stesse del corrispettivo OpenSource ma risulta preconfigurato per gestire tutte le funzionalità presenti, come ad esempio la gestione della connessione radiomobile.
