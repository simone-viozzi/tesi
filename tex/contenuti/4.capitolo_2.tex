...
%TODO e' copiato e incollato va sistemato!
\begin{itemize}
...
%TODO don't like
Per effettuare le varie operazioni di testing e' stato aggiunta \it{raspberry pi} che ha svolto il ruolo di "host domotico". Sono state fatti test con ping e tracepath per testare che tutta la topologia sia stata configurata correttamente.
...
\begin{itemize}
	...
	\item su linux e' sufficiente cercare nei repository ufficiali della distribuzione che si sta usando, es. Ubuntu: \code{apt-get install openvpn}.
\end{itemize}
