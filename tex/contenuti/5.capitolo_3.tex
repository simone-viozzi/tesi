...
Per la gestione dell'autenticazione dei client alla VPN è necessario creare una \textit{PKI}, come descritto nella sezione \ref{subsec:auth}, per una maggiore sicurezza è indicato separare la \textit{Certificate Authority} dal \textit{Server OpenVPN}.

La gestione della PKI viene fatta usando l'utility \textit{easy-rsa}, possiamo riassumere i comandi principali della sua creazione nel seguente schema:
...
\todo[fare in modo che sotto fa riferimento al diagramma]
