...
Andiamo quindi a usare l'albero di cartelle creato in code:~\ref{code:init-easyrsa} e diamo il comando \\\code{easyrsa init-pki}, ciò creerà i file e le cartelle necessarie alla gestione della PKI.
