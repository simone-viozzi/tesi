...
In questa struttura di cartelle verranno creati i vari file necessari per la gestione della PKI. In base ai comandi si creerà una struttura differente nella cartella pki.
