...
Sapendo che l'IP pubblico del Server è \code{51.178.141.119}, si avrà una configurazione iniziale come in figura \ref{fig:diag-simple_ips}.
...
In questo caso il nome dell'interfaccia di rete è \textit{ens3}. E' quindi possibile procedere con la configurazione del NAT:
