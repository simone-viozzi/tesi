% <-- chapter -->
\chapter{Configurazione del \textit{Server} \todo[da togliere il siamo e mette passivo]}
\label{ch:server}
...
\newpage
Andiamo quindi a creare un nuovo file \code{vars} \todo[è ok lasciare queste?]:
