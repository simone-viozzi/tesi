...
Si puo' vedere come l'ip assegnato al \it{client} dalla vpn e' \code{10.8.0.2}.
...
Si vede quindi che e' possibile una comunicazione bidirezionale tra \it{client}, \code{10.8.0.2}, e \it{server}, \code{10.8.0.1}.