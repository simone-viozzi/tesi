...
Dato che non possiamo sapere a priori quanti client si connetteranno contemporaneamente alla VPN, per sapere sempre quale ip viene assegnato al router e' necessario assegnargliene uno statico. Questo viene fatto usando la \code{cleint-config-dir}.
...
Cosi' facendo al router gli verra' sempre assegnato l'ip \code{10.8.0.254}, indipendentemente dall'ordine in cui gli host si connettono alla vpn. Cio' ci permette di sapere sempre e a priori qual'e' l'ip del router.
