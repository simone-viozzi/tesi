...
Comparirà inoltre l'interfaccia \code{tun0} a cui è stato assegnato l'indirizzo \code{10.8.0.10}.
...
Dato che non possiamo sapere a priori quanti client si connetteranno contemporaneamente alla VPN, per sapere sempre quale ip viene assegnato al router è necessario assegnargliene uno statico. Questo viene fatto usando la \code{cleint-config-dir}.
