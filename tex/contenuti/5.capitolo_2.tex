...
Supponiamo inoltre che che l'ip pubblico del server sia \code{51.178.141.119}, si avra' quindi una configurazione:

\begin{figure}[ht]

    \centering
	\includesvg[width=250px]{immagini/diag-simple_ips}
	\caption{ \cite{icons}}
